...
var Yogaexercises = function Yogaexercises(props) {
  return __jsx(_components_MyLayout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: this
  }, "List out the execises here, pull from API"), __jsx("ul", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    __self: this
  }, console.log(props), console.log(props.poses), props.poses.map(function (pose) {
    return (// <li key={pose.id}>
...
//# sourceMappingURL=yogaexercises.js.2c4a46eadad31ed6da1e.hot-update.js.map